...
class ClienteBancario:
    ...
    def imprimirInfo(self) -> str:
        return "Nombre: " + self.getNombreCompleto() + ", Edad: " + str(self.__edad) + ",Balance: " + str(self.balanceDeCuenta)
    ...
    def guardarDinero(self, cantidad:float) -> None:
        ...
        self.__mandarEmail("----guardar deposito----", "se recibieron" + str(cantidad))
